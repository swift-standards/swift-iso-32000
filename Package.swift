...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/swift-standards/swift-w3c-png.git", from: "0.0.1"),
        .package(url: "https://github.com/swift-standards/swift-iso-14496-22.git", from: "0.0.1"),
