...
// MARK: - Standard 14 Font Metrics

extension ISO_32000.Font.Standard14 {
    ...
    public var metrics: ISO_32000.Font.Metrics {
        ...
        case .helveticaOblique:
            return .helvetica  // Same metrics as Helvetica
        case .helveticaBoldOblique:
            return .helveticaBold  // Same metrics as Helvetica-Bold
        case .timesRoman:
            return .timesRoman
        case .timesBold:
            return .timesBold
        case .timesItalic:
            return .timesRoman  // Same metrics as Times-Roman
        case .timesBoldItalic:
            return .timesBold  // Same metrics as Times-Bold
        case .courier, .courierBold, .courierOblique, .courierBoldOblique:
            return .courier  // All Courier variants are monospaced at 600
        case .symbol:
            return .symbol
        case .zapfDingbats:
            return .zapfDingbats
