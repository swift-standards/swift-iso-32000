...
struct `ISO_32000.Writer Tests` {
    ...
    func `Outputs all Standard 14 fonts for inspection`() throws {
        ...
        for font in ISO_32000.Font.Standard14.allCases {
            ...
            contentBuilder.showText("\(font.rawValue): The quick brown fox jumps over the lazy dog.")
            y -= 30
        ...
        let document = ISO_32000.Document(
            ...
            info: ISO_32000.Info(title: "Standard 14 Fonts")
        )
